...
TARGET_DTB_LIST_WILDCARD := exynos/s5e9945
...
# Modules
BOARD_RECOVERY_RAMDISK_KERNEL_MODULES_LOAD := $(shell cat $(COMMON_PATH)/configs/modules/ramdisk) $(BOARD_RECOVERY_RAMDISK_KERNEL_MODULES_LOAD)
BOARD_SYSTEM_KERNEL_MODULES_LOAD := $(shell cat $(COMMON_PATH)/configs/modules/system)
